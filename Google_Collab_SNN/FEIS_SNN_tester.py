...
from FEIS_utils import tasks, raw_folders, experiments_dir
...
def run_testing(folders, task, max_epoch):
    ...
    for folder in folders:
        ...
        for fold_number in range(5):
            SNN_data_dir = 'drive/MyDrive/Kaggle_Runner/FEIS_SNN_data/'
            ...
            for train_test in train_test_index:
                ...
                train_data = []
                ML_data = band_pass_and_notch_filter_data(ML_data, 256)
