...
from kara_one_utils import tasks, experiments_dir
...
def run_SNN_Training(folder, fold_number, task, epochs):
    ...
    SNN_data_dir = 'drive/MyDrive/Kaggle_Runner/kara_one_SNN_data/' #'D:/MSc_Software_Systems/Research Project/FEIS/code_classification/kara_one_SNN_data/' #'
    ...
    train_data = []
    task_dict['data'] = down_sample_and_filter(task_dict['data'])
