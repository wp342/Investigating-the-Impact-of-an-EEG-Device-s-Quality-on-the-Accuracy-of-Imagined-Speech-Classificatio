...
#experiments_dir = 'D:/MSc_Software_Systems/Research Project/FEIS/code_classification/kara_one_non_zero_raw_data/'
#SNN_data_dir = 'D:/MSc_Software_Systems/Research Project/FEIS/code_classification/kara_one_SNN_data/'
...
def perform_csp_channel_selection(thinking, labels, task, n):
    ...
    return combined_indices, zero_indices, one_indices
